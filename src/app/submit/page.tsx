...
export default function SubmitPage() {
  ...
  return (
    <PageTransition className="mx-auto max-w-3xl px-4 py-32 md:px-8">
      <h1 className="mb-4 text-4xl font-black">Ajukan Peluang Baru</h1>
      <p className="mb-10 text-on-surface-variant dark:text-[#94a3b8]">
        Bantu ribuan mahasiswa lainnya dengan membagikan informasi beasiswa, magang, atau lomba yang kamu ketahui.
      </p>
      ...
      <form onSubmit={handleSubmit} className="card-shadow space-y-6 rounded-2xl border-4 border-black bg-white p-8 dark:border-white dark:bg-[#1e293b]">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div>
            ...
            <input required name="socialMedia" className="w-full rounded-xl border-2 border-black bg-surface-container-low px-4 py-3 outline-none focus:ring-2 focus:ring-primary dark:border-[#334155] dark:bg-[#334155]" placeholder="IG: @beasiswa_id" />
          </div>
          <div>
            <label className="mb-2 block font-bold">Website Penyelenggara</label>
            <input required type="url" name="website" className="w-full rounded-xl border-2 border-black bg-surface-container-low px-4 py-3 outline-none focus:ring-2 focus:ring-primary dark:border-[#334155] dark:bg-[#334155]" placeholder="https://..." />
          </div>
          <div>
